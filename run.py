...
parser.add_argument("-d", "--data_path", type=str,
                    help="Path to training, valid and test data sets",default='./cf')
parser.add_argument("-a", "--aux_path", type=str, help="Path to R, D_all sets",default='./')
...
parser.add_argument("-o", "--res_dir", type=str,
                    help="Path to ConvMF's result",default='./')
...
parser.add_argument("-u", "--lambda_u", type=float,
                    help="Value of user regularizer",default=100)
parser.add_argument("-v", "--lambda_v", type=float,
                    help="Value of item regularizer",default=10)
